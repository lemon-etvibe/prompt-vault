...
- **Architecture**: See [ARCHITECTURE.md](ARCHITECTURE.md) for plugin internals
...
- **[ARCHITECTURE.md](ARCHITECTURE.md)** — Plugin technical internals and developer guide
- **[GETTING_STARTED.md](GETTING_STARTED.md)** — Step-by-step tutorial and hands-on guide
